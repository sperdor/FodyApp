...
public class FoodSelectorDinner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uid = user.getUid();
        setContentView(R.layout.activity_food_selector_dinner);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                entityDinner dinner = new entityDinner();
                dinner.setUid(uid);
                dinner.setFood(classFood.id);
                dinner.setDate(getCurrentDate());
                dinner.setQuantity(qty);
                dinner.setNameFood(classFood.name);
                dinner.setScore(classFood.score);
