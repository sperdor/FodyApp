...
public class FoodSelectorLunch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                entityLunch lunch = new entityLunch();
                lunch.setUid(uid);
                lunch.setFood(classFood.id);
                lunch.setDate(getCurrentDate());
                lunch.setQuantity(qty);
                lunch.setNameFood(classFood.name);
                lunch.setScore(classFood.score);
