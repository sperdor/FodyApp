...
public class FoodSelectorSnack extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                entitySnack snack = new entitySnack();
                snack.setUid(uid);
                snack.setFood(classFood.id);
                snack.setDate(getCurrentDate());
                snack.setQuantity(qty);
                snack.setNameFood(classFood.name);
                snack.setScore(classFood.score);
